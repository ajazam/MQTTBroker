...
use crate::properties::{invalid_property_for_packet_type, non_unique, Property};
use thiserror::Error;
use tracing::trace;
...
pub mod properties {
    ...
    use crate::packets::properties::private::ModifyProperties;
    use crate::properties::{PropertyIdentifier, PropertyIdentifierConstant};
    use paste::paste;
    ...
    mod private {
        use crate::packets::properties::PropertyContainer;
        use crate::primitive_types::{
            BinaryData, Byte, FourByteInteger, TwoByteInteger, Utf8EncodedString, Utf8StringPair,
            VariableByteInteger,
        };
        use crate::properties::PropertyIdentifier;
        use std::collections::HashMap;
...
mod properties_test {
    mod tests {
        ...
        use crate::primitive_types::TwoByteInteger;
        // #[test]
        ...
        use crate::packets::properties::ServerKeepAlive;
        use crate::packets::properties::{ConnAckProperties, PublishProperties};
